...
<!-- Banners Start -->
<div class="banner affiliate" id="home" style="background-image: url('/assets/img/bg-2.jpg')">
    <!-- hero-area Start -->
    <div class="hero-area">
        <div class="container">
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 ">
                <div class="upper-content wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
                    <h4 class="lasthead">What You’ll Get As an Affiliate</h4>
                ...
                <div class="affiliate-box" style="background: url('/assets/img/map.png')">
                    ...
                    <div class="affiliate-bottom wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
                        <p class="text">Make money with LotusProtocol</p>
                        <a href="#" class="custom-button button-1">
                            Coming Soon <i class="flaticon-right"></i>
                        </a>
                    </div>
                </div>
            </div>
...
<div class="counter" style="background-image: url('/assets/img/counter-bg.png')">
    <div class="container">
        <div class="row">
            <h4 class="lasthead text-center" style="color:#eee">Our Affiliate Target</h4>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <div class="upper-content wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
                    <h4 class="lasthead">You will be Part of something Big</h4>
                    <h2 class="title">$50,257,285.47</h2>
                    <p class="text">
                        Total Commissions to Paid to Our Affiliates
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6">
                <div class="why-affiliate-content">
                    ...
                    <a  href="#" class="custom-button button-1 wow fadeInUp" data-wow-duration="0.3s"
                        data-wow-delay="0.3s">>Coming Soon!</a>
                </div>
            </div>
